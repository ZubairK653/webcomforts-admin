            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="process/save_page.php" method="post" enctype="multipart/form-data"
                            id="main_form">
                            ...
                            <div class="card-body">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="title" placeholder="Enter Title"
                                            id="title" required="required" value="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Tag Line
                                    </label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-4">
                                    <label
                                        class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Portfolio</label>
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="is_portfolio">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Popular</label>
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="is_headline" id="is_headline">
                                            <option value="0" selected="selected">No</option>
                                            <option value="1">Yes</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Show
                                        Pic</label>
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="show_picondetails" id="show_picondetails">
                                            <option value="0" selected="selected">No</option>
                                            <option value="1">Yes</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Portfolio URL
                                    </label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="url_portfolio" id="url_portfolio" class="form-control"
                                            value="">

                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Picture
                                        (Square)</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Main
                                        Category</label>
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="parent_id" id="parent_id" >
                                            <option value="0" selected="selected">No</option>
                                            <option value="1">Yes</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Sub
                                        Category</label>
                                    <div class="col-sm-12 col-md-7">
                                    <input type="checkbox"  class="" value="" name="Field[]" />
                                    Sub cat title
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
